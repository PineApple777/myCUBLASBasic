...
simpleCUBLAS.o: simpleCUBLAS.cpp
	$(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $(OBJECTPATH)/$@ -c $<

$(TARGET): simpleCUBLAS.o
	$(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -o $(BINARYPATH)/$@ $(OBJECTPATH)/$+ $(LIBRARIES)
	mkdir -p $(BINARYPATH)/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)
	cp $(BINARYPATH)/$@ $(BINARYPATH)/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)

run: build
	./$(BINARYPATH)/simpleCUBLAS

clean:
	rm -f $(BINARYPATH)/$(TARGET) $(OBJECTPATH)/*.o
	rm -rf $(BINARYPATH)/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/$(OBJECTPATH)/$(TARGET)
